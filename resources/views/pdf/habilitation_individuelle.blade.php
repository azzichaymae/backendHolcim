...
<body>
    <div class="page">
        ...
        <table class="signature-table">
            ...
            <tr>
                <td id="emp">
                    {{ $validation->etapes[0]->confirmed_at ? 'Validé le '. \Carbon\Carbon::parse($validation->etapes[0]->confirmed_at)->format('d/m/Y') : '' }}
                </td>
                <td id="respService">
                   
                    {{ $validation->etapes[1]->confirmed_at ?'Validé le '. \Carbon\Carbon::parse($validation->etapes[1]->confirmed_at)->format('d/m/Y') : '' }}
                </td>
                <td id="respDepartement">
                    
                    {{ $validation->etapes[2]->confirmed_at ?'Validé le '. \Carbon\Carbon::parse($validation->etapes[2]->confirmed_at)->format('d/m/Y') : '' }}
                </td>
                <td id="respSanteSecurite">
                    
                    {{ $validation->etapes[3]->confirmed_at ? 'Validé le '. \Carbon\Carbon::parse($validation->etapes[3]->confirmed_at)->format('d/m/Y') : '' }}
                </td>
                <td id="directeurUsine">
                     
                    {{ $validation->etapes[4]->confirmed_at ? 'Validé le '.\Carbon\Carbon::parse($validation->etapes[4]->confirmed_at)->format('d/m/Y') : '' }}
                </td>
            </tr>
