  ...
  <div class="employee-list">
    ...
    <div class="page-header">
      <div>
        ...
        <p class="page-subtitle">{{ total }} employé(s) trouvé(s)</p>
      </div>
    ...
    <div class="filters-bar">
      ...
      <select v-model="filters.departement_id" @change="onDepartementChange"
              class="filter-select" v-if="!isManager">
      ...
      <select v-model="filters.service_id" @change="fetchEmployees"
              class="filter-select" v-if="!isManager">
      ...
      <table class="data-table">
        ...
        <tbody>
          <tr v-for="emp in employees" :key="emp.id"
              @click="goToDetail(emp.id)" class="table-row">
            <td>
            ...
            <td class="td-muted">{{ emp.service?.nom }}</td>
            <td class="td-muted">{{ emp.service?.departement?.nom }}</td>
            <td>
            ...
            <td @click.stop>
              <div class="actions">
                <router-link :to="`/employees/${emp.id}/edit`"
                  class="action-btn edit" v-if="canWrite"
                  title="Modifier">
                  <span v-html="icons.edit"></span>
                </router-link>
                <button class="action-btn delete" v-if="canDelete"
                  @click="confirmDelete(emp)" title="Supprimer">
